...
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'EasyRent';
  static const String androidPackageName = 'com.broker.vrs';
  ...
  ///API Setting
  static const String hostUrl = "https://easerent.in/";
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  static const String shareNavigationWebUrl = "https://easyrents.page.link";
  ...
  static const String deepLinkPrefix =
      "https://easyrents.page.link"; //demo.page.link
  ///set anything you want
  static const String deepLinkName = "easerent"; //deeplink demo.com
  ///!TODO: End deprecated
